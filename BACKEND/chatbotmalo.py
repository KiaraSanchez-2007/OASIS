...
# --------------------------------------------------
    ...
    def guardar_nombre(self, nombre):
        ...
        if nombre == "":
            return {
                "mensaje": "🌿 Antes de continuar, por favor escribe tu nombre."
            }

        self.memoria.guardar_nombre(nombre)

        # El menú principal seguirá usando el estado 'evaluacion'
        ...
        return {
            "mensaje":
                ...
                "Soy OASIS, tu asistente virtual de bienestar universitario.\n\n"
                "Estoy aquí para acompañarte y brindarte apoyo cuando lo necesites.\n\n"
...
# --------------------------------------------------
    ...
    def evaluar(self, opcion):
        ...
        # ===============================
            ...
            return {
            "mensaje":
                "📋 Evaluaremos tu nivel de estrés.\n\n"
                "Responde usando:\n\n"
                "0️⃣ Nunca\n"
                "1️⃣ Rara vez\n"
                "2️⃣ A veces\n"
    ...
    # ===============================
        ...
        return {
            "mensaje":
                "📚 Excelente.\n\n"
                "Cuéntame cuál es la actividad o tarea que deseas organizar."
        }
